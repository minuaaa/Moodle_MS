...
/**
 * Strings for component 'assign', language 'lt', version '4.2'.
 *
 * @package     assign
 * @category    string
...
$string['allowsubmissionsanddescriptionfromdatesummary'] = 'Užduoties detalės ir darbo įkėlimo forma bus galima nuo <strong>{$a}</strong>';
...
$string['allowsubmissionsfromdatesummary'] = 'Užduotis priims darbus nuo <strong>{$a}</strong>';
...
$string['assignmentisdue'] = 'Užduoties atlikimo laikas baigės';
...
$string['batchoperationlock'] = 'užrakinti pateikimus';
$string['batchoperationreverttodraft'] = 'paversti darbus į juodraštį';
$string['batchoperationsdescription'] = 'Su pasirinktais...';
$string['batchoperationunlock'] = 'atrakinti pateikimus';
...
$string['blindmarkingenabledwarning'] = 'Šiai veiklai įjungti "Anonimiški pateikimai". Įvertinimai nebus įtrauki į įvertinimų knygelę kol besimokančiųjų tapatybės nebus atskleistos per vertinimo veiksmų meniu.';
...
$string['deleteallsubmissions'] = 'Ištrinti visus darbus';
...
$string['maxattempts'] = 'Maksimalus bandymų skaičius';
...
$string['maxperpage_help'] = 'Didžiausias užduočių skaičius, kurį vertintijas gali rodyti užduočių vertinimo puslapyje. Šis nustatymas naudingas norint išvengti kursų, kuriuose dalyvauja daug dalyvių, skirtojo laiko.';
...
$string['privacy:metadata:assignmessageexplanation'] = 'Žinutės studentams siunčiamos per pranešimų sistemą.';
...
$string['requireallteammemberssubmit_help'] = 'Jei įgalinta, visi besimokančiųjų grupės nariai privalo paspausti pateikimo mygtuką, norėdami pateikti grupės darbą.
Jei išjungta, grupės atliktas darbas bus laikomas pateiktu, kai nors vienas grupės narys paspaus pateikimo mygtuką.';
...
$string['viewgradebook'] = 'Pamatyti įvertinimų knygelę';
