...
/**
 * Strings for component 'qbehaviour_deferredcbm', language 'lt_uni', version '4.2'.
 *
...
$string['certainty1'] = 'Nelabai gerai (mažiau nei 67%)';
$string['certainty2'] = 'Patenkinamai (daugiau nei 67%)';
$string['certainty3'] = 'Gerai (daugiau nei 80%)';
$string['howcertainareyou'] = 'Ar jūs tuo tikras? {$a}';
