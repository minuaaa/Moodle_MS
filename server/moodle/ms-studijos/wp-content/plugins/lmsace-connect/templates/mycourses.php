...
if ( !empty($courses) ) {
		...
		?>
			<div class="product-item col-md-3">
				...
				<div class="product-details">
					...
					<a class="button button-primary moodle-course-access" href="<?php echo esc_attr( $thiscourseurl ); ?>" > <?php echo esc_html( __("Eiti į kursą", 'lmsconnect') ); ?> </a>
				</div>
			</div>
		<?php
	}
	...
	<div class="no-enrolled-courses">
		<h3> <?php echo esc_html( __('Jus dar nesate įtrauktas į kursą..', LAC_TEXTDOMAIN) ); ?></h3>
	</div>
<?php
}
