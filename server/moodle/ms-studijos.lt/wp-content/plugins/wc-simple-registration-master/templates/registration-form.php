...
?><div class="registration-form woocommerce">
	...
	<h2><?php _e( 'Registruotis', 'woocommerce-simple-registration' ); ?></h2>
	...
	<form method="post" class="register">
		...
		<p class="woocomerce-FormRow form-row">
			...
			<input type="submit" class="woocommerce-Button button" name="register" value="<?php esc_attr_e( 'Registruotis', 'woocommerce-simple-registration' ); ?>" />
		</p>
