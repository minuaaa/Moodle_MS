...
/**
 * Strings for component 'auth', language 'lt', version '4.2'.
 *
 * @package     auth
 * @category    string
...
Jūs paprašėte pakeisti el. pašto adresą jūsų naudotojo paskyrai puslapyje {$a->site}. Prašome atidaryti žemiau esančią nuorodą naršyklėje, šio pakeitimo patvirtinimui.
...
$string['username_help'] = 'Atminkite, kad kai kurie autentifikavimo įskiepiai neleis pakeisti naudotojo vardo.';
