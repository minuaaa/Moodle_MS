...
/**
 * Strings for component 'report_security', language 'lt', version '4.2'.
 *
...
$string['check_mediafilterswf_details'] = '<p>Labai pavojinga leisti automatiškai įdėti .swf – bet kuris registruotasis naudotojas gali paleisti XSS ataką prieš kitus serverio naudotojus. Išjunkite šį parametrą gamybos serveriuose.</p>';
...
$string['check_passwordpolicy_details'] = '<p>Rekomenduojama nustatyti slaptažodžio strategiją, nes dažniausiai neteisėta prieiga gaunama atspėjus slaptažodį. Neiškelkite per griežtų reikalavimų, nes tada naudotojams bus sudėtinga prisiminti savo slaptažodį ir jie arba jį pamirš, arba turės užsirašyti.</p>';
...
$string['check_webcron_name'] = 'Žiniatinklio kronas';
