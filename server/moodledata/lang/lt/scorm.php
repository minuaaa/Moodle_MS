...
/**
 * Strings for component 'scorm', language 'lt', version '4.2'.
 *
 * @package     scorm
 * @category    string
...
$string['completionstatusallscos'] = 'Reikalauti, kad visi SC grąžintų užbaigimo būseną';
...
$string['displayactivityname'] = 'Rodyti veiklos pavadinimą';
$string['displayactivityname_help'] = 'Ar rodyti veiklos pavadinimą virš SCORM grotuvo, ar ne.';
...
$string['privacy:metadata:scorm_scoes_track'] = 'Stebimi veiklai priklausančių SCO duomenys';
