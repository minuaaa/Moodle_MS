<?php
/**
 * eLearning customizer class for theme customize sanitizes.
 *
 * Class eLearning_Customizer_FrameWork_Sanitizes
 *
 * @package    ThemeGrill
...
/**
 * eLearning customizer class for theme customize callbacks.
 *
 * Class eLearning_Customizer_FrameWork_Sanitizes
 */
class eLearning_Customizer_FrameWork_Sanitizes {
	...
	public static function sanitize_typography( $typography_args, $setting ) {
		...
		if ( isset( $typography_args['subsets'] ) ) {
			...
			$subsets        = eLearning_Fonts::get_google_font_subsets();
