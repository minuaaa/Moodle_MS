...
/**
 * Class eLearning_Dimensions_Control
 */
class eLearning_Dimensions_Control extends eLearning_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'elearning-dimensions';
