...
/**
 * Strings for component 'tool_task', language 'lt', version '4.2'.
 *
 * @package     tool_task
 * @category    string
...
$string['asap'] = 'Kaip galima greičiau';
...
$string['checkcronrunning'] = 'Cron veikia';
...
$string['taskfailures'] = '{$a} užduotis nepavyko';
