...
if ( ! class_exists( 'eLearning_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class eLearning_WebFont_Loader {
		...
		public function get_base_path() {
			if ( ! $this->base_path ) {
				 ...
				 * @since   1.0.0
				 */
				$this->base_path = apply_filters( 'elearning_get_local_fonts_base_path', $this->get_filesystem()->wp_content_dir() );
			}
		...
		public function get_base_url() {
			if ( ! $this->base_url ) {
				 ...
				 * @since   1.0.0
				 */
				$this->base_url = apply_filters( 'elearning_get_local_fonts_base_url', content_url() );
			}
		...
		public function get_subfolder_name() {
			if ( ! $this->subfolder_name ) {
				 ...
				 * @since   1.0.0
				 */
				$this->subfolder_name = apply_filters( 'elearning_get_local_fonts_subfolder_name', 'fonts' );
			}
...
if ( ! function_exists( 'elearning_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function elearning_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new eLearning_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'elearning_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function elearning_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new eLearning_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
