...
/**
 * Strings for component 'tool_uploaduser', language 'lt', version '4.2'.
 *
...
$string['examplecsv'] = 'Teksto failo pavyzdys';
$string['examplecsv_help'] = 'Norėdami naudoti teksto failo pavyzdį, atsisiųskite jį, tada atidarykite naudodami teksto arba skaičiuoklės rengyklę. Palikite pirmąją eilutę nepakeistą, tada redaguokite kitas eilutes (įrašus) ir pridėkite savo naudotojo duomenis, prireikus pridėdami daugiau eilučių. Išsaugokite failą kaip CSV, tada įkelkite.

Teksto failo pavyzdys taip pat gali būti naudojamas testavimui, nes galite peržiūrėti naudotojo duomenis ir pasirinkti atšaukti veiksmą prieš sukuriant naudotojo abonementus.';
...
$string['matchemail'] = 'El. pašto adreso atsitikimas';
...
* Privalomi laukų pavadiniami yra naudotojo vardas, slaptažodis, vardas, pavardė, el. paštas';
