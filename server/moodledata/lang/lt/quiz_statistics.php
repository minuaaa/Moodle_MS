...
/**
 * Strings for component 'quiz_statistics', language 'lt', version '4.2'.
 *
...
$string['negcovar_help'] = 'Šis testo bandymų rinkinio klausimų įvertis yra priešingas bendram bandymų įverčiui. Tai reiškia, kad bendras bandymų įvertis būna žemesnis už vidurkį, kai klausimo įvertis yra aukštesnis už vidurkį, ir atvirkščiai. Paveikaus klausimo svorio lygties šiuo atveju apskaičiuoti neįmanoma. Kitų šio testo klausimų paveikaus svorio apskaičiavimų rezultati reiškia, kad šių klausimų svoris paveikus, jei paryškintų klausimų su neigiama koveriacija maksimalus įvertis yra nulis. Jei redaguojate testą ir suteikiate šiam (-iems) klausimui (-ams) su neigiama koveriacija maksimalų įvertį – nulis, tada paveikus šių klausimų svoris bus lygus nuliui, o tikras paveikus kitų klausimų svoris bus toks, kaip apskaičiuota dabar.';
