...
/**
 * Strings for component 'portfolio', language 'lt_uni', version '4.2'.
 *
 * @package     portfolio
 * @category    string
...
$string['commonsettingsdesc'] = '<p>Nuo perdavimo trukmės slenksčio reikšmės „Vidutinė“ arba „Ilga“ priklauso, ar vartotojas galės palaukti ir perdavimą užbaigti, ar ne.</p><p>Perdavimai, kurių trukmė yra iki slenksčio reikšmės „Vidutinė“, tiesiog vyksta neklausus vartotojo, o perdavimai, kurių trukmė yra „Vidutinė“ ir „Ilga“, siūlomi pasirinkti, tačiau įspėjama, kad tai gali užtrukti.</p><p>Be to, kai kurie portfelio papildiniai gali visiškai nepaisyti šios parinkties ir visus perdavimus priverstinai įrašyti į eilę.</p>';
...
$string['enableddesc'] = 'Tai leis administratoriams sukonfigūruoti nuotolines sistemas, į kurias vartotojai galėtų eksportuoti turinį';
...
$string['invaliduserproperty'] = 'Nepavyko rasti tokios {$a->class}) vartotojo konfigūravimo ypatybės ({$a->property}';
