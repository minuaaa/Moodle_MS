...
/**
 * Strings for component 'badges', language 'lt', version '4.2'.
 *
 * @package     badges
 * @category    string
...
$string['activatesuccess'] = 'Prieiga prie šio pasiekimo buvo sėkmingai įgalinta.';
$string['addalignment'] = 'Pridėti išorinį įgūdį arba standartą';
$string['addbackpack'] = 'Pridėti pasiekimų talpyklę';
...
$string['awardoncron'] = 'Pasiekimai buvo sėkmingai įgalinti. Šį pasiekimą iš kart gali gauti per daug naudotojų. Norint išlaikyti svetainės greitaveiką tinkame lygyje, šio veiksmo apdorojimas šiek tiek užtruks.';
...
$string['backpackconnection'] = 'Saugyklos jungtis';
$string['backpackconnection_help'] = 'Prisijungę prie išorinės saugyklos, galite bendrinti savo pasiekimus iš šios svetainės ir rodyti savo viešas pasiekimų kolekcijas iš saugyklos svetainės profilio puslapyje.';
...
$string['backpackemailverifyemailbody'] = 'Sveiki,

iš svetainės „{$a->sitename}“ naudojant Jūsų el. pašto adresą buvo paprašytas naujas prisijungimas prie „Badges“ saugyklos.

Norėdami patvirtinti ir suaktyvinti ryšį su saugykla, eikite šiuo adresu

{$a->link}

Daugelyje pašto programų, nuoroda turėtų būti aktyvi, kurią galite tiesiog spustelėti. Jei neveikia, tuomet nukopijuokite nuorodos adresą ir įklijuokite į adreso eilutę interneto naršyklės viršuje.
...
$string['backpackemailverifypending'] = 'Patvirtinimo e. laiškas išsiųstas <strong>{$a}</strong>. El. laiške spustelėkite patvirtinimo nuorodą saugyklos sujungimo aktyvavimui.';
$string['backpackemailverifysuccess'] = 'Ačiū, kad patvirtinote savo el. pašto adresą. Dabar esate prijungtas prie saugyklos.';
...
$string['deactivatesuccess'] = 'Pasiekimas sėkmingai išjungtas.';
...
$string['error:backpacknotavailable'] = 'Jūsų svetainė yra nepasiekiama internete, todėl bet kuris pasiekimas gautas šioje svetainėje negalės būti patikrintas išorinėje saugykloje.';
$string['error:backpackproblem'] = 'Atsirado problemų jungiantis prie Jūsų saugyklos paslaugos tiekėjo. Pabandykite vėliau.';
...
$string['error:notifycoursedate'] = 'Įspėjimas: pasiekimai susieti su kurso ir veiklų baigimu nebus suteikti kol nebus pasiekta kurso pradžios data.';
...
$string['numawards'] = 'Vartotojų gavusių pasiekimą skaičius: <a href="{$a->link}">{$a->count}</a>';
$string['numawardstat'] = 'Šis pasiekimas skirtas {$a} naudotojui(-jams)';
...
$string['recipientdetails'] = 'Informacija apie gavėją';
$string['recipientidentificationproblem'] = 'Šio pasiekimo gavėjo nepavyko rasti tarp esamų naudotojų';
...
$string['sitebackpack'] = 'Aktyvi išorinė pasiekimų talpykla';
$string['sitebackpack_help'] = 'Išorinė pasiekimų talpykla, prie kurios naudotojai gali prisijungti iš šios svetainės. Atminkite, kad pakeitus šį nustatymą po to, kai naudotojai prijungs savo pasiekimų talpyklos, kiekvienas naudotojas turės eiti į savo pasiekimų talpyklos nustatymų puslapį ir atsijungti, tada vėl prisijungti.';
