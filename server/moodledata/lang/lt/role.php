...
/**
 * Strings for component 'role', language 'lt', version '4.2'.
 *
 * @package     role
 * @category    string
...
$string['site:messageanyuser'] = 'Apeiti naudotojo privatumo nuostatas, kad galėtumėte siųsti pranešimus bet kuriam naudotojui';
