...
/**
 * Strings for component 'mnet', language 'lt_uni', version '4.2'.
 *
 * @package     mnet
 * @category    string
...
$string['RPC_HTTPS_SELF_SIGNED'] = 'HTTPS (vartotojo pasirašyta)';
$string['RPC_HTTPS_VERIFIED'] = 'HTTPS (pasirašyta)';
$string['RPC_HTTP_PLAINTEXT'] = 'HTTP neiššifruota';
$string['RPC_HTTP_SELF_SIGNED'] = 'HTTP (vartotojo pasirašyta)';
...
$string['authfail_usermismatch'] = 'Autorizuoti nepavyko: neatitinka vartotojas.';
...
$string['deleteuserrecord'] = 'SSO ACL: naikinti vartotojo {$a->user} iš {$a->host} įrašą.';
...
$string['duplicate_usernames'] = 'Mums nepavyko sukurti jūsų vartotojo lentelės stulpelių „mnethostid“ ir „username“ indekso.<br />Tai galėjo įvykti dėl vartotojo vardų dublikatų <a href=rdblquote{$a}" target="_blank">jūsų vartotojo lentelėje</a>.<br />Versijos naujinimas turėtų būti baigtas sėkmingai. Spustelėję aukščiau esantį saitą naujame lange pamatysite instrukcijas, kaip spęsti šią problemą. Tuo galite pasidomėti versijos naujinimo pabaigoje.<br />';
$string['enabled_for_all'] = '(Ši paslauga įjungta visuose pagrindiniuose kompiuteriuose).';
$string['enterausername'] = 'Įveskite vartotojo vardą arba kableliais atskirtų vartotojo vardų sąrašą.';
$string['error7020'] = 'Ši klaida paprastai įvyksta, kai nuotolinė svetainė sukuria jūsų įrašą su klaidinga „www“ šaknimi, pvz., ne http://www.jūsųsvetainė.lt, o http://jūsųsvetainė.lt. Turėtumėte susisiekti su nuotolinės svetainės administratoriumi dėl „www“ šaknies (kaip nurodyta „config.php“) ir paprašyti, kad atnaujintų jūsų pagrindinio kompiuterio įrašą.';
$string['error7022'] = 'Į nuotolinę svetainę išsiųsta jūsų žinutė buvo tinkamai užšifruota, bet nepasirašyta. Tai labai netikėta; taip įvykus tikriausiai turėtumėte registruoti klaidą (užklausoje nurodyti kuo daugiau informacijos apie taikomųjų programų versijas ir t. t.).';
...
$string['error7024'] = 'Į nuotolinę svetainę išsiuntėte neiššifruotą žinutę, tačiau nuotolinė svetainė iš jūsų svetainės nepriima neiššifruotų ryšių. Tai labai netikėta; taip įvykus tikriausiai turėtumėte registruoti klaidą (užklausoje nurodyti kuo daugiau informacijos apie taikomųjų programų versijas ir t. t.).';
...
$string['failedaclwrite'] = 'Nepavyko įrašyti į vartotojo {$a} „MNet“ prieigos teisių sąrašą.';
...
$string['hidelocal'] = 'Slėpti vietos vartotojus';
$string['hideremote'] = 'Slėpti nuotolinius vartotojus';
...
$string['hostexists'] = 'Jau yra pagrindinio kompiuterio su tokiu pagrindinio kompiuterio vardu įrašas (jį galima panaikinti). <a href="{$a}">Spustelėkite čia</a> norėdami redaguoti šį įrašą.';
...
$string['http_self_signed_help'] = 'Leidžia ryšius naudojant vartotojo pasirašytą DIY SSL sertifikatą nuotoliniame pagrindiniame kompiuteryje.';
...
$string['https_self_signed_help'] = 'Leidžia ryšius naudojant vartotojo pasirašytą DIY SSL (PHP kalba) nuotoliniame pagrindiniame kompiuteryje per HTTP.';
...
$string['loginlinkmnetuser'] = '<br />Jei esate „MNet“ nuotolinis vartotojas ir galite <a href="{$a}">patvirtinti savo el. pašto adresą čia</a>, galite būti nukreipti į savo prisijungimo puslapį.<br />';
...
$string['mnet_session_prohibited'] = 'Jūsų pagrindinio serverio vartotojams dabar neleidžiama jungtis tarptinkliniu ryšiu prie {$a}.';
$string['mnetdisabled'] = '„MNet“ yra <strong>išjungtas</strong>.';
$string['mnetidprovider'] = '„MNet“ ID teikėjas';
$string['mnetidproviderdesc'] = 'Naudokite šią priemonę norėdami gauti saitą, kuriuo galėtumėte prisijungti, jei galite nurodyti teisingą el. pašto adresą, kad būtų palygintas vartotojo vardas, kurį naudodami bandėte prisijungti anksčiau.';
...
$string['nolocaluser'] = 'Nėra nuotolinio vartotojo vietinio įrašo ir jo nepavyko sukurti, nes šis pagrindinis kompiuteris automatiškai vartotojų nekuria. Susisiekite sus sistemos administratoriumi.';
...
$string['notpermittedtojumpas'] = 'Jūs galite pradėti nuotolinę sesiją kai esate prisijungęs kaip kitas vartotojas';
$string['notpermittedtoland'] = 'Neturite teisių pradėti nuotolinio seanso.';
$string['off'] = 'Išjungta';
$string['on'] = 'Įjungta';
$string['options'] = 'Parinktys';
$string['peerprofilefielddesc'] = 'Čia galite perrašyti visuotinius parametrus, pagal kuriuos siunčiami ir importuojami profilio laukai, kai sukuriami nauji vartotojai.';
...
$string['profilefielddesc'] = 'Čia galite konfigūruoti sąrašą profilio laukų, kurie buvo išsiųsti ir gauti per „MNet“ sukūrus arba atnaujinus vartotojų paskyras. Taip pat galite perrašyti pagal kiekvieną „MNet“ lygiavertį elementą. Atminkite, kad šie laukai visada yra siunčiami ir nėra pasirinktiniai: {$a}.';
...
$string['reallydeleteserver'] = 'Ar tikrai norite naikinti šį serverį?';
...
$string['remoteuserinfo'] = 'Nuotolinis {$a->remotetype} vartotojas – profilis iškviestas iš <a href={$a->remoteurl} > {$a->remotename}</a>';
...
$string['showlocal'] = 'Rodyti vietos vartotojus';
$string['showremote'] = 'Rodyti nuotolinius vartotojus';
$string['ssl_acl_allow'] = 'SSO ACL: leisti vartotoją {$a->user} iš {$a->host}.';
$string['ssl_acl_deny'] = 'SSO ACL: drausti vartotoją {$a->user} iš {$a->host}.';
$string['ssoaccesscontrol'] = 'SSO prieigos valdymas';
$string['ssoacldescr'] = 'Naudokite šį puslapį norėdami suteikti / uždrausti konkrečių vartotojų prieigą iš nuotolinių „MNet“ pagrindinių kompiuterių. Tai veikia, kai nuotoliniams vartotojams siūlote SSO paslaugas. Norėdami valdyti <em>vietos</em> vartotojų galimybę jungtis tarptinkliniu ryšiu prie kitų „MNet“ pagrindinių kompiuterių, naudokite vaidmenų sistemą ir suteikite jiems <em>mnetlogintoremote</em> galimybę.';
...
$string['usercannotchangepassword'] = 'Negalite čia pakeisti savo slaptažodžio, nes esate nuotolinis vartotojas.';
...
$string['usersareonline'] = 'Įspėjimas. Šiuo metu iš šio serverio prie jūsų svetainės yra prisijungusių vartotojų: {$a}.';
