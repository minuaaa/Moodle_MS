...
/**
 * Strings for component 'block_accessreview', language 'lt', version '4.2'.
 *
...
$string['showbackground'] = 'Rodyti tik fono spalvą';
$string['showboth'] = 'Rodyti ir fono spalvą, ir būsenos piktogramas';
$string['showicon'] = 'Rodyti šypsenėlę';
$string['showicons'] = 'Rodyti tik skaičiaus piktogramas';
...
$string['toolpage'] = 'Įrankių rinkinio puslapis, kurį norite rodyti';
$string['totalerrors'] = '<em>Iš viso klaidų:</em> {$a} <br>(iš viso neįtraukiami kurso nustatymai)';
$string['viewreport'] = 'Peržiūrėti';
$string['viewreportalt'] = 'Peržiūrėti pritaikymo įrankių rinkinį';
$string['whattoshow'] = 'Ką rodyti kurso puslapyje';
