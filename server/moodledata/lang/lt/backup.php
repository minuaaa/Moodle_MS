...
/**
 * Strings for component 'backup', language 'lt', version '4.2'.
 *
 * @package     backup
 * @category    string
...
$string['asyncemailenable'] = 'Įgalinti žinučių pranešimus';
...
$string['asyncrestorepending'] = 'Laukiama atkūrimo proceso';
...
$string['backupcoursedetails'] = 'Išsami kursų informacija';
$string['backupcoursesection'] = '{$a} dalis';
$string['backupcoursesections'] = 'Kursų dalys';
...
$string['choosefilefromactivitybackup_help'] = 'Veiklos atsarginės kopija, padaryta naudojant numatytuosius parametrus, yra saugoma čia.';
$string['choosefilefromautomatedbackup'] = 'Automatinės atsarginės kopijos';
$string['choosefilefromautomatedbackup_help'] = 'Yra automatiškai sugeneruotų atsarginių kopijų';
$string['choosefilefromcoursebackup'] = 'Kursų atsarginės kopijos sritis';
$string['choosefilefromcoursebackup_help'] = 'Kursų atsarginės kopijos pagal numatytuosius parametrus yra saugomos čia.';
$string['choosefilefromuserbackup'] = 'Naudotojo asmeninė atsarginės kopijos sritis';
$string['choosefilefromuserbackup_help'] = 'Čia saugomi atsarginės kopijos failai su anonimine naudotojo informacija.';
...
$string['copycoursedesc'] = 'Šis kursas bus nukopijuotas ir įtrauktas į pasirinktą kursų kategoriją.';
...
$string['coursecategory'] = 'Kategorija Kursai bus atkurta';
...
$string['enableasyncbackup_help'] = 'Jei įjungta, visos atsarginės kopijos kūrimo ir atkūrimo operacijos bus atliekamos asinchroniškai. Tai neturi įtakos importui ir eksportui. Asinchroninės atsarginės kopijos ir atkūrimas leidžia naudotojams atlikti kitas operacijas, kol vyksta atsarginės kopijos kūrimas arba atkūrimas.';
...
$string['importfile'] = 'Importuoti atsarginės kopijos failą';
...
$string['unnamedsection'] = 'Nenurodyta dalis';
