 ...
 *
 * Class eLearning_Sortable_Control
 *
 * @package    ThemeGrill
 ...
 * Class eLearning_Sortable_Control
 */
class eLearning_Sortable_Control extends eLearning_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type       = 'elearning-sortable';
	...
	protected function content_template() {
		...
		<ul class="unsortable">
			...
			<li {{{ data.inputAttrs }}} class='elearning-sortable-item' data-value='{{ choiceID }}'>
				<i class="dashicons dashicons-visibility visibility"></i>
				{{{ choiceLabel }}}
			</li>
			<# }else { #>
			<li {{{ data.inputAttrs }}} class='elearning-sortable-item invisible' data-value='{{ choiceID }}'>
				<i class="dashicons dashicons-visibility visibility"></i>
				{{{ choiceLabel }}}
			</li>
			<# } #>
