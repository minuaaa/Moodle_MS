...
/**
 * Strings for component 'admin', language 'lt', version '4.2'.
 *
 * @package     admin
 * @category    string
...
$string['configallowobjectembed'] = 'Numatytoji saugos priemonė numato, kad įprastiems naudotojams neleidžiama įdėti multimedijos (pvz., „Flash“) į tekstus, naudojant detalias žymes EMBED ir OBJECT jų HTML (nors tai vis tiek galima saugiai atlikti naudojant filtrą „mediaplugins“). Jei norite leisti naudoti šias žymes, įjunkite šią parinktį.';
...
$string['configcookiehttponly'] = 'Įjungia naują PHP 5.2.0 funkciją – naršyklėms nurodoma siųsti slapuką tik su tikromis HTTP užklausomis, slapukai neturėtų būti prieinami naudojant scenarijų kalbas. Ši funkcija nepalaikoma visose naršyklėse ir gali būti ne visiškai suderinama su esamu kodu. Ji padeda išvengti kai kurių tipų XSS atakų.';
...
$string['configdocroot'] = 'Apibrėžia kelią į Moodle dokumentus, kad būtų galima teikti su kontekstu susijusią dokumentaciją per kiekvieno puslapio poraštėje esančias nuorodas „Pagalba ir dokumentacija“. Jei laukas paliekamas tuščias, nuorodos nebus rodomos.';
...
$string['configenableactivitychooser'] = 'Veiklos parinkiklis yra dialogo langas su trumpu kiekvienos veiklos ir ištekliaus aprašymu. Jei išjungta, vietoj to pateikiami atskiri išteklių ir veiklų išskleidžiamieji meniu.';
...
$string['configgeoipfile'] = 'GeoLite2 City dvejetainių duomenų failo vieta. Šis failas nėra Moodle platinimo dalis ir jį reikia įsigyti atskirai iš <a href="https://www.maxmind.com/">MaxMind</a>. Galite nusipirkti komercinę versiją arba naudoti nemokamą versiją. Turėsite užsiregistruoti, kad atsisiųstumėte miesto duomenų bazės failą. Tai galite padaryti adresu <a href="https://dev.maxmind.com/geoip/geoip2/geolite2/" >https://dev.maxmind.com/geoip/geoip2/geolite2/</a>. Užsiregistravę ir atsisiuntę failą, išskleiskite jį į savo serverio katalogą „{$a}“.';
...
$string['configmodchooserdefault'] = 'Ar veiklų parinkiklis turi būti pateikiamas naudotojams pagal nutylėjimą?';
$string['configmycoursesperpage'] = 'Maksimalus kursų, rodomų bet kuriame naudotojo kursų sąraše, skaičius';
...
$string['configpasswordpolicy'] = 'Jei įjungta, naudotojų slaptažodžiai bus tikrinami pagal slaptažodžių politiką, kaip nurodyta toliau pateiktuose nustatymuose. Slaptažodžių politikos įjungimas neturės įtakos esamiems naudotojams, kol jie nuspręs arba neprivalės pakeisti savo slaptažodžio arba nebus įjungtas nustatymas „Tikrinti slaptažodį prisijungus“.';
$string['configpasswordpolicycheckonlogin'] = 'Jei įjungta, naudotojų slaptažodžiai bus tikrinami pagal slaptažodžių politiką kiekvieną kartą, kai naudotojas prisijungs. Jei patikrinti nepavyks, prieš tęsdamas naudotojas turės pakeisti slaptažodį.
Šį nustatymą naudinga įjungti atnaujinus slaptažodžio politiką.';
...
$string['configproxybypass'] = 'Kableliais atskirtų (dalinių) pagrindinių kompiuterių pavadinimų arba IP, kurie turėtų apeiti tarpinį serverį, sąrašas, (pvz., 192.168., .mydomain.com)';
...
$string['configsmartpix'] = 'Įjungus šį parametrą, piktogramos teikiamos naudojant PHP scenarijų, kuris ieško dabartinėje temoje, tada – visose pagrindinėse temose, tada –  „Moodle“ aplanke /pix. Taip sumažinamas poreikis dubliuoti vaizdų failus temose, bet šiek tiek sumažėja našumas.';
...
$string['coursecolorheading_desc'] = 'Visi kursai, kuriuose kurso nustatymuose nenurodytas kurso paveikslėlis, yra rodomi "Mano pagrindinis" puslapyje su raštuota kurso kortele. Rašte naudojamos spalvos gali būti nurodytos žemiau.';
...
$string['coursecontactduplicates_desc'] = 'Jei įjungta, naudotojai, turintys daugiau nei vieną iš pasirinktų kurso kontaktinių vaidmenų, bus rodomi kurso aprašyme su kiekvienu jų vaidmeniu. Kitu atveju jie bus rodomi tik su vienu vaidmeniu (atsižvelgiant į tai, kuris Svetainės administracijos skiltyje „Apibrėžti vaidmenis“ yra aukščiausias).';
...
$string['coursepage'] = 'Kurso puslapis';
...
$string['debugtemplateinfo_desc'] = 'Jei įjungta, atvaizdavimui naudojami šablonai rodomi kaip komentarai puslapio HTML. Naudokite tik laikinai derindami, nes tai sukelia HTML patvirtinimo klaidas ir gali sugadinti kai kuriuos puslapio skriptus.';
...
$string['enableactivitychooser'] = 'Įjungti veiklos parinkiklį';
...
$string['eventshandlersinuse'] = 'Jūsų sistemoje šie įskiepiai naudoja "Events 1 API deprecated" tvarkykles: "{$a}". Atnaujinkite juos, kad jie naudotų Events 2 API. Žr. https://docs.moodle.org/dev/Events_API#Event_dispatching_and_observers.';
...
$string['groupenrolmentkeypolicy_desc'] = 'Jei įjungta, grupės registracijos raktai bus patikrinti pagal slaptažodžių politiką, kaip nurodyta anksčiau pateiktuose nustatymuose.';
...
$string['iplookupgeoplugin'] = 'Šiuo metu geografinei informacijai ieškoti naudojama paslauga <a href="https://www.geoplugin.com">geoPlugin</a>. Norėdami gauti tikslesnius rezultatus, rekomenduojame įdiegti vietinę MaxMind GeoLite duomenų bazės kopiją.';
...
$string['iplookupmaxmindnote'] = 'Šiame produkte yra „MaxMind“ sukurtų „GeoLite2“ duomenų, kuriuos galima rasti adresu <a href="https://www.maxmind.com">https://www.maxmind.com</a>.';
...
$string['langpackwillbeupdated'] = 'PASTABA: atnaujinant versiją, „Moodle“ bandys atsisiųsti jūsų kalbos paketų naujinimu.';
...
$string['lockoutemailbody'] = 'Jūsų paskyra su naudotojo vardu {$a->username} serveryje „{$a->sitename}“
buvo užrakinta po kelių neteisingų bandymų prisijungti.

Norėdami atrakinti paskyrą, nedelsdami eikite šiuo adresu
...
eilutę žiniatinklio naršyklės lango viršuje.
...
$string['mediapluginswfnote'] = 'Taikant numatytąsias saugos priemones, įprastiems naudotojams neturėtų būti leidžiama įdėti „swf“ „Flash“ failų.';
...
$string['messagingcategory'] = 'Pranešimai';
...
$string['modchooserdefault'] = 'Veiklų parinkiklio numatytosios reikšmės';
...
$string['multilangforceold'] = 'Reikalauti taikyti senąją kelių kalbų sintaksę: &lt;span&gt; be class="multilang" ir &lt;lang&gt;';
...
$string['mymoodleredirect'] = 'Reikalauti, kad naudotojai naudotų Mano „Moodle“';
...
$string['pluginsoverviewsee'] = 'Žiūrėti <a href="{$a->url}">įskiepių peržiūros</a>  puslapį, kad gauti daugiau informacijos.';
...
$string['registrationwarning'] = 'Jūsų svetainė dar neregistruota.';
$string['registrationwarningcontactadmin'] = 'Svetainė dar neužregistruota. Prašome pranešti administratoriui.';
...
$string['sitesectionhelp'] = 'Jei pasirinkta, temos skyrius bus rodomas pagrindiniame svetainės puslapyje.';
...
$string['smartpix'] = 'Išmani paveikslėlių paieška';
$string['smtp'] = 'SMTP';
...
$string['taskmessagingcleanup'] = 'Foninis apdorojimas pranešimų siuntimui';
...
$string['taskquestionstatscleanupcron'] = 'Fono apdorojimas, skirtas klausimų statistikos talpykloms išvalyti';
...
$string['testoutgoingmailconf_fromemail'] = 'Iš naudotojo vardo arba el. pašto adreso';
...
$string['testoutgoingmailconf_sentmail'] = 'Ši svetainė sėkmingai išsiuntė testinį pranešimą į pašto serverį. <br />Nuo: {$a->fromemail}<br />Kam: {$a->toemail}';
...
$string['themeselect'] = 'Pasirinkite temą';
...
$string['unicoderequired'] = 'Reikalaujama saugoti visus duomenis „Unicode“ (UTF-8) formatu. Duomenų bazėse turi būti atliekamos naujos įdiegtys, kurių numatytasis simbolių rinkinys yra „Unicode“. Jei atnaujinate versiją, turėtumėte atlikti perkėlimo į UTF-8 procesą (Žr. puslapį Administratorius).';
...
$string['updateautocheck_desc'] = 'Jei įgalinta, Jūsų svetainė automatiškai tikrins "Moodle" ir visų papildomų įskiepių kodo atnaujinimus. Jei naujas kodas bus rastas, pranešimas bus išsiųstas visiems svetainės administratoriams.';
...
$string['upgradepluginsinfo_help'] = 'Kai kuriems Jūsų įskiepiams yra prienami atnaujinimai. Prieš atnaujinant Moodle duomenų bazę, juos turėtumėte įdiegti.  Jei svetainėje nėra palaikomas automatinis atnaujinimas, turite atsisiųsti atnaujinimą ir įdiegti jį savo serveryje rankiniu būdu.';
...
$string['userfiltersdefault_desc'] = 'Pasirinkite filtrus, kurie turėtų būti rodomi puslapyje „Naršyti naudotojų sąrašą“ ir „Masiniai naudotojų veiksmai“. Norėdami pasirinkti kelis elementus, laikykite nuspaudę klavišą Ctrl. Visi nepasirinkti filtrai bus pasiekiami spustelėjus nuorodą „Rodyti daugiau“.';
