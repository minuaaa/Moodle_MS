 ...
 *
 * Class eLearning_Radio_Image_Control
 *
 * @package    ThemeGrill
 ...
 * Class eLearning_Radio_Image_Control
 */
class eLearning_Radio_Image_Control extends eLearning_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'elearning-radio-image';
	...
	protected function content_template() {
		...
		<div id="input_{{ data.id }}" class="image image-col-{{{ data.image_col }}}">
			...
			<label for="{{ data.id }}{{ key }}" {{{ data.labelStyle }}} class="elearning-radio-image">
