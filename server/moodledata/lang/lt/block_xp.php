...
/**
 * Strings for component 'block_xp', language 'lt', version '4.2'.
 *
 * @package     block_xp
 * @category    string
...
$string['activityoresourceis'] = 'Veikla arba išteklius yra {$a}';
$string['addacondition'] = 'Įtraukti sąlygą';
$string['addarule'] = 'Įtraukti taisyklę';
...
$string['anonymity_help'] = 'Nustatymas nustato, ar dalyviai gali matyti vienas kito vardą ir piktogramą.';
$string['awardaxpwhen'] = '<strong>{$a}</strong> taškai gaunami kai:';
...
$string['configdescription'] = 'Aprašymas';
...
$string['congratulationsyouleveledup'] = 'Sveikiname!';
...
$string['coursevisuals'] = 'Išvaizda kurse';
$string['customizelevels'] = 'Nustatyti lygius';
$string['dangerzone'] = 'Pavojaus zona';
$string['defaultlevels'] = 'Numatytieji lygiai';
$string['defaultrules'] = 'Numatytosios taisyklės';
...
$string['defaultvisuals'] = 'Numatyta išvaizda';
$string['deletecondition'] = 'Pašalinti sąlygas';
$string['deleterule'] = 'Pašalinti taisykles';
$string['description'] = 'Aprašymas';
$string['difference'] = 'Skirtumas';
$string['discoverlevelupplus'] = 'Atrask Level up! Plus';
...
$string['enableinfos'] = 'Leisti informacijos puslapį';
$string['enableinfos_help'] = 'Nustačius \'Ne\' (No), mokiniai negalės peržiūrėti informacinio puslapio.';
$string['enableladder'] = 'Įjungti reitingavimą';
$string['enableladder_help'] = 'Nustačius \'Ne\' (No), mokiniai negalės peržiūrėti reitingų.';
$string['enablelevelupnotif'] = 'Leisti įskiepio žinutes';
...
$string['enablexpgain'] = 'Įjungti taškų pasiekimą';
...
$string['ladderempty'] = 'Reitingas šiuo metu tuščias, sugrįškite vėliai!';
$string['learnmore'] = 'Sužinok daugiau';
$string['level'] = 'Lygis';
$string['levelbadges'] = 'Pasiekiami lygiai';
$string['levelbadgesformhelp'] = 'Failus pavadinkite [lygis].[failo plėtinys], pavyzdžiui: 1.png, 2.jpg, ... ir t. t. Rekomenduojamas paveikslėlio dydis yra 100x100.';
$string['levelcount'] = 'Lygio skaičius';
...
$string['levelswillbereset'] = 'Įspėjimas! Šios formos išsaugojimas perskaičiuos visų lygį!';
$string['levelup'] = 'Pasikelk lygį!';
$string['levelupplus'] = 'Level up! XP+';
$string['levelx'] = 'Lygis #{$a}';
$string['likenotice'] = '<strong>Jums patinka šis papildinys?</strong> Skirkite šiek tiek laiko šio papildinio įtraukimui tarp savo mėgstamų svetainėje <a href="{$a->moodleorg}" target="_blank"> Moodle.org</a>ir pažymėkite <a href="{$a->github}" target="_blank">GitHub</a>.';
$string['limitparticipants'] = 'Dalyvių riba';
...
$string['pointsrequired'] = 'Reikalingi taškai';
$string['privacy:metadata:log'] = 'Saugoti įvykių žurnalą';
...
$string['privacy:metadata:xp'] = 'Saugomi naudotojo taškai ir lygis';
...
$string['promoerrorsendingemail'] = 'O! Mums nepavyko išsiųsti žinutės... prašome rašyti mums tiesiogiai el. paštu: {$a}. Thanks!';
...
$string['rank'] = 'Reitingas';
$string['ranking'] = 'Reitingavimas';
...
$string['reallyresetdata'] = 'Ar tikrai norite iš naujo nustatyti šiame kurse visų lygius ir taškus?';
$string['reallyresetgroupdata'] = 'Ar tikrai norite iš naujo nustatyti šios grupės lygius ir taškus?';
...
$string['recommendedplugins'] = 'Rekomenduojami įskiepiai';
...
$string['resetcoursedata'] = 'Atnaujinti kurso duomenis';
$string['resetcourserulestodefaults'] = 'Kurso taisyklių numatytųjų nustatymų atkūrimas';
$string['resetgroupdata'] = 'Atnaujinti grupės duomenis';
...
$string['rulecm'] = 'Veikla ar išteklius';
$string['rulecm_help'] = 'Ši sąlyga įvykdoma, kai įvykis įvyksta nurodytoje veikloje arba resurse.';
$string['rulecmdesc'] = 'Veikla ar išteklius \'{$a->contextname}\'.';
$string['rulecmdescwithcourse'] = 'Veikla arba resursas yra: \'{$a->contextname}\', \'{$a->coursename}\'.';
...
$string['taskcollectionloggerpurge'] = 'Valyti rinkimo žurnalus';
...
$string['usealgo'] = 'Naudoti algoritmą';
$string['usecustomlevelbadges'] = 'Naudokite pasirinktinius lygio ženkliukus';
$string['usecustomlevelbadges_help'] = 'Kai nustatyta „Taip“, reikia pateikti kiekvieno lygio paveikslėlius.';
$string['usingalgo'] = 'Algoritmo naudojimas';
$string['value'] = 'Reikšmė';
$string['valuessaved'] = 'Reikšmės sėkmingai išsaugotos.';
$string['viewas'] = 'Rofyti kaip';
$string['viewlogs'] = 'Rodyti įrašus';
$string['viewtheladder'] = 'Peržiūrėti reitingą';
$string['visualsintro'] = 'Įkelkite paveikslėlius lygių išvaizdos nustatymui.';
...
$string['xp:addinstance'] = 'Įtraukti naują bloką';
$string['xp:earnxp'] = 'Taškų rinkimas';
$string['xp:manage'] = 'Valdykite visus patirties taškų aspektus';
$string['xp:myaddinstance'] = 'Įtraukti bloką į puslapį „Mano pagrindinis“';
$string['xp:view'] = 'Peržiūrėti bloką ir su juo susijusius puslapius';
...
$string['youreachedlevela'] = 'Jūs pasiekėte lygį {$a}!';
$string['yourmessage'] = 'Jūsų žinutė';
$string['yourownrules'] = 'Jūsų taisyklės';
