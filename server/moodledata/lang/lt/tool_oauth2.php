...
/**
 * Strings for component 'tool_oauth2', language 'lt', version '4.2'.
 *
 * @package     tool_oauth2
 * @category    string
...
$string['createnewfacebookissuer'] = 'Sukurti naują Facebook paslaugą';
$string['createnewgoogleissuer'] = 'Sukurti naują Google paslaugą';
$string['createnewissuer'] = 'Sukurti naują tinkintą paslaugą';
$string['createnewmicrosoftissuer'] = 'Sukurti naują Microsoft paslaugą';
$string['createnewnextcloudissuer'] = 'Sukurti naują Nextcloud paslaugą';
