 ...
 *
 * Class eLearning_Typography_Control
 *
 * @package    ThemeGrill
 ...
 * Class eLearning_Typography_Control
 */
class eLearning_Typography_Control extends eLearning_Customize_Base_Additional_Control {
	 ...
	 * @var string
	 */
	public $type = 'elearning-typography';
	...
	public function enqueue() {
		...
		$google_font_subsets = eLearning_Fonts::get_google_font_subsets();
		$localize_scripts    = array(
			'standardfontslabel' => esc_html__( 'Standard Fonts', 'elearning' ),
			'googlefontslabel'   => esc_html__( 'Google Fonts', 'elearning' ),
		...
		if ( ! empty( $custom_fonts ) ) {
			$localize_scripts['customfontslabel'] = esc_html__( 'Custom Fonts', 'elearning' );
		...
		wp_localize_script(
			...
			'eLearningCustomizerControlTypography',
			$localize_scripts
		);
		...
		wp_localize_script(
			'elearning-customize-controls',
			'eLearningCustomizerControlTypographySubsets',
			$google_font_subsets
		);
	...
	protected function format_variants_array( $variants ) {
		...
		$font_variants  = eLearning_Fonts::get_font_variants();
	...
	public function get_system_fonts() {
		...
		$standard_fonts       = eLearning_Fonts::get_system_fonts();
	...
	public function get_google_fonts() {
		...
		$google_fonts          = eLearning_Fonts::get_google_fonts();
		$font_variants         = eLearning_Fonts::get_font_variants();
		$foogle_fonts__subsets = eLearning_Fonts::get_google_font_subsets();
	...
	public function get_custom_fonts() {
		...
		$custom_fonts       = eLearning_Fonts::get_custom_fonts();
	...
	public function to_json() {
		...
		$this->json['languages']   = eLearning_Fonts::get_google_font_subsets();
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			...
			<div class="font-family">
				<span class="customize-control-title"><?php esc_html_e( 'Family', 'elearning' ); ?></span>
				<div class="elearning-field-content">
					<select {{{ data.inputAttrs }}} id="elearning-font-family-{{{ data.id || data.name }}}"></select>
				</div>
			</div>

			<# if ( data.default['font-weight'] ) { #>
			<div class="font-weight">
				<span class="customize-control-title"><?php esc_html_e( 'Weight', 'elearning' ); ?></span>
				<div class="elearning-field-content">
					<select {{{ data.inputAttrs }}} id="elearning-font-weight-{{{ data.id || data.name }}}"></select>
				</div>
			</div>
			<# } #>
			...
			<div class="subsets">
				<span class="customize-control-title"><?php esc_html_e( 'Subset(s)', 'elearning' ); ?></span>
				<div class="elearning-field-content">
					<select {{{ data.inputAttrs }}} id="elearning-subsets-{{{ data.id || data.name }}}" multiple>
			...
			<div class="font-size">
				<span class="customize-control-title"><?php esc_html_e( 'Size', 'elearning' ); ?></span>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="elearning-font-size-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="elearning-font-size-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['font-size'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="elearning-font-size-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['font-size'] ) { #>
			...
			<div class="line-height">
				<span class="customize-control-title"><?php esc_html_e( 'Line Height', 'elearning' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="elearning-line-height-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="elearning-line-height-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['line-height'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="elearning-line-height-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['line-height'] ) { #>
			...
			<div class="letter-spacing">
				<span class="customize-control-title"><?php esc_html_e( 'Letter Spacing', 'elearning' ); ?></span>
				<ul class="responsive-switchers">
					<li class="desktop">
						<button type="button" class="preview-desktop active" data-device="desktop">
							<i class="dashicons dashicons-desktop"></i>
				...
				<div class="desktop control-wrap active">
					<input type="text"
						   id="elearning-letter-spacing-desktop-{{{ data.id || data.name }}}"
						   data-device="desktop"
				...
				<div class="tablet control-wrap">
					<input type="text"
						   id="elearning-letter-spacing-tablet-{{{ data.id || data.name }}}"
						   data-device="tablet"
							<# if ( data.value['letter-spacing'] ) { #>
				...
				<div class="mobile control-wrap">
					<input type="text"
						   id="elearning-letter-spacing-mobile-{{{ data.id || data.name }}}"
						   data-device="mobile"
							<# if ( data.value['letter-spacing'] ) { #>
			...
			<div class="font-style">
				<span class="customize-control-title"><?php esc_html_e( 'Style', 'elearning' ); ?></span>
				<div class="elearning-field-content">
					<select {{{ data.inputAttrs }}} id="elearning-font-style-{{{ data.id || data.name }}}">
						<option value="normal"
						<# if ( 'normal' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Normal', 'elearning' ); ?></option>
						<option value="italic"
						<# if ( 'italic' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Italic', 'elearning' ); ?></option>
						<option value="oblique"
						<# if ( 'oblique' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Oblique', 'elearning' ); ?></option>
						<option value="initial"
						<# if ( 'initial' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Initial', 'elearning' ); ?></option>
						<option value="inherit"
						<# if ( 'inherit' === data.value['font-style'] ) { #> selected <# }
						#>><?php esc_html_e( 'Inherit', 'elearning' ); ?></option>
					</select>
				</div>
			</div>
			<# } #>
			...
			<div class="text-transform">
				<span class="customize-control-title"><?php esc_html_e( 'Transform', 'elearning' ); ?></span>
				<div class="elearning-field-content">
					<select {{{ data.inputAttrs }}} id="elearning-text-transform-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'elearning' ); ?></option>
						<option value="capitalize"
						<# if ( 'capitalize' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Capitalize', 'elearning' ); ?></option>
						<option value="uppercase"
						<# if ( 'uppercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Uppercase', 'elearning' ); ?></option>
						<option value="lowercase"
						<# if ( 'lowercase' === data.value['text-transform'] ) { #> selected <# }
						#>><?php esc_html_e( 'Lowercase', 'elearning' ); ?></option>
						<option value="initial"
			...
			<div class="text-decoration">
				<span class="customize-control-title"><?php esc_html_e( 'Decoration', 'elearning' ); ?></span>
				<div class="elearning-field-content">
					<select {{{ data.inputAttrs }}} id="elearning-text-decoration-{{{ data.id || data.name }}}">
						<option value="none"
						<# if ( 'none' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'None', 'elearning' ); ?></option>
						<option value="underline"
						<# if ( 'underline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Underline', 'elearning' ); ?></option>
						<option value="overline"
						<# if ( 'overline' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Overline', 'elearning' ); ?></option>
						<option value="line-through"
						<# if ( 'line-through' === data.value['text-decoration'] ) { #> selected <# }
						#>><?php esc_html_e( 'Line Through', 'elearning' ); ?></option>
						<option value="initial"
