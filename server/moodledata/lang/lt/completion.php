...
/**
 * Strings for component 'completion', language 'lt', version '4.2'.
 *
 * @package     completion
 * @category    string
...
$string['activitycompletion'] = 'Veiklos užbaigimas';
...
$string['badautocompletion'] = 'Kai pasirenkate užbaigti automatiškai, taip pat turite įjungti bent vieną reikalavimą (žemiau).';
...
$string['completion_automatic'] = 'Rodyti veiklą kaip užbaigtą, kai išpildomos sąlygos';
...
$string['completion_manual'] = 'Užbaigę veiklą besimokantieji gali ją pažymėti neautomatiniu būdu';
$string['completion_none'] = 'Nepažymėti, kad veikla užbaigta';
...
$string['completionexpected'] = 'Tikėtina užbaigimo data';
$string['completionexpected_help'] = 'Šis nustatymas nurodo datą, kada veikla turi būti baigta. Kai artėja data, veikla pateikiama "Mano pagrindinis" bloke "Laiko juosta".';
...
$string['completionpassgrade_desc'] = 'Besimokantysis turi gauti išlaikymo įvertį, kad užbaigtų šią veiklą';
...
$string['completionusegrade_desc'] = 'Besimokantysis turi gauti įvertį, kad užbaigtų šią veiklą';
...
$string['completionview_desc'] = 'Besimokantysis turi peržiūrėti šią veiklą, kad ją užbaigtų';
...
$string['yourprogress'] = 'Jūsų pažanga';
