...
/**
 * Strings for component 'enrol_self', language 'lt', version '4.2'.
 *
 * @package     enrol_self
 * @category    string
...
$string['customwelcomemessage_help'] = 'Pasirinktinis pasveikinimo pranešimas gali būti pridedamas kaip paprastas tekstas ar kaip Moodle-automatinis formatas, įskaitant HTML žymas ir multi-lang žymas.

Į pranešimą gali būti įtraukti šie pamainymai:

* Kurso pavadinimas {$a->coursename}
* Nuoroda į naudotojo profilio puslapį {$a->profileurl}
* Naudotojo e.paštas {$a->email}
* Visas naudotojo vardas {$a->fullname}';
