...
/**
 * Strings for component 'webservice', language 'lt', version '4.2'.
 *
 * @package     webservice
 * @category    string
...
$string['usernameoridnousererror'] = 'Nerastas nei vienas naudotojas su naudotojo vardu/ naudotojo id.';
$string['usernameoridoccurenceerror'] = 'Daugiau nei vienas naudotojas buvo rastas su tokiu naudotojo vardu. Prašau įvesti naudotojo id.';
