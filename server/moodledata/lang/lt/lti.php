...
/**
 * Strings for component 'lti', language 'lt', version '4.2'.
 *
 * @package     lti
 * @category    string
...
$string['display_name_help'] = 'Jei pasirinkta, veiklos pavadinimas (nurodytas aukščiau) bus rodomas virš įrankio teikėjo turinio.

Gali būti, kad įrankio tiekėjas taip pat gali rodyti pavadinimą. Ši parinktis gali užkirsti kelią veiklos pavadinimo rodymui du kartus.

Pavadinimas niekada nerodomas, kai įrankio paleidimo konteineris yra naujame lange.';
