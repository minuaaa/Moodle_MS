...
class __Mustache_5843e8e4bbf625e3b9374534c01be08a extends Mustache_Template
{
...
';
            ...
            $buffer .= $this->sectionBcd1693be5a9e6853ccadbdb44b70108($context, $indent, $value);
            $buffer .= $indent . '                    </div>
';
            $buffer .= $indent . '                </div>
';
...
';
    ...
    private function sectionBcd1693be5a9e6853ccadbdb44b70108(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '                                        <button type="button" class="btn btn-icon carousel-navigation-link text-decoration-none text-body" data-carousel-target-id="carousel-item-';
