...
/**
 * Strings for component 'condition', language 'lt_uni', version '4.2'.
 *
 * @package     condition
 * @category    string
...
$string['adduserfields'] = 'Įtraukite {no} vartotojo lauko sąlygas į formą';
$string['availabilityconditions'] = 'Apriboti prieigą';
$string['availablefrom'] = 'Leisti prieigą nuo';
$string['availablefrom_help'] = 'Prieigos pradžios / pabaigos datos, nustatančios, kada klausytojai gali pasiekti veiklą naudodami kursų puslapio nuorodą. Veiklos prieigos pradžios / pabaigos datų ir pasiekiamumo parametrų nustatymas skiriasi tuo, kad klausytojai gali peržiūrėti veiklos aprašą praėjus parametruose nustatytam laikotarpiui, o nustačius prieigos pradžios / pabaigos datas kitu laikotarpiu visiškai negalima pasiekti veiklos.';
...
$string['requires_completion_1'] = 'Negalima, jei veikla <strong>{$a}</strong> pažymėta kaip užbaigta.';
$string['requires_completion_2'] = 'Negalima, jei veikla <strong>{$a}</strong> yra užbaigta ir išlaikyta.';
...
$string['requires_grade_any'] = 'Negalima, jei turite įvertį už <strong>{$a}</strong>.';
$string['requires_grade_max'] = 'Negalima, jei negavote atitinkamo balo už <strong>{$a}</strong>.';
$string['requires_grade_min'] = 'Negalima, jei turite reikiamą balą už <strong>{$a}</strong>.';
$string['requires_grade_range'] = 'Negalima, jei negavote tam tikro balo už <strong>{$a}</strong>.';
$string['showavailability'] = 'Kad veikla galėtų būti pasiekiama';
$string['showavailability_hide'] = 'Visiškai paslėpti veiklą';
...
$string['userrestriction_hidden'] = 'Apribota (visiškai paslėpta, be žinučių): &lsquo;{$a}&rsquo;';
$string['userrestriction_visible'] = 'Apribota: &lsquo;{$a}&rsquo;';
