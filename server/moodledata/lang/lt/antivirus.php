...
/**
 * Strings for component 'antivirus', language 'lt', version '4.2'.
 *
 * @package     antivirus
 * @category    string
...
$string['actantivirushdr'] = 'Prieinami antivirusinės programos įskiepiai';
$string['antiviruscommonsettings'] = 'Įprasti antivirusinės nustatymai';
$string['antiviruses'] = 'Antivirusinės programos įskiepiai';
