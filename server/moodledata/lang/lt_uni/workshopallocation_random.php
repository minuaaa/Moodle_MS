...
/**
 * Strings for component 'workshopallocation_random', language 'lt_uni', version '4.2'.
 *
...
$string['nogroupusers'] = '<p>Įspėjimas: jei seminaras veikia „matomų grupių“ arba „atskirų grupių“ režimu, vartotojai PRIVALO būti bent vienos grupės nariai, kad šis įrankis priskirtų jiems kolegų įvertinimus. Grupėje nesantiems vartotojams vis tiek gali būti teikiami nauji savęs įvertinimai arba pašalinami esami įvertinimai.</p> <p>Šie vartotojai šiuo metu nėra grupėje: {$a}</p>';
...
$string['resultnumperreviewer'] = 'Bandoma perskirstyti {$a} peržiūras redaktorių';
