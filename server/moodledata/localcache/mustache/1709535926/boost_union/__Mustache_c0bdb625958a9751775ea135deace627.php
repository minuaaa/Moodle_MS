...
class __Mustache_c0bdb625958a9751775ea135deace627 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section4bf7014bada2f962b95127b7d2de7376($context, $indent, $value);
        $value = $context->find('hasidentityproviders');
        $buffer .= $this->section8cf67954f6915f3b6c94047df9a08c4b($context, $indent, $value);
...
';
    ...
    private function section4bf7014bada2f962b95127b7d2de7376(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionC51218ca7f22631ef4561f542b635230(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionE60b3907a0186896823330be961f7d98(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                <a class="btn login-identityprovider-btn btn-block btn-secondary" href="';
...
';
    ...
    private function section8cf67954f6915f3b6c94047df9a08c4b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionC51218ca7f22631ef4561f542b635230($context, $indent, $value);
                $value = $context->find('identityproviders');
                $buffer .= $this->sectionE60b3907a0186896823330be961f7d98($context, $indent, $value);
                $buffer .= $indent . '        </div>
';
                $context->pop();
            }
