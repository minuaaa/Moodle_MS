...
/**
 * Strings for component 'lesson', language 'lt', version '4.2'.
 *
 * @package     lesson
 * @category    string
...
$string['essay'] = 'Esė';
$string['essayemailmessage2'] = '<p>Esė raginimas:{$a->question}</p><p>Jūsų atsakymas:<em>{$a->response}</em></p><p>Vertintojo komentarai:<em>{$a->comment}</em></p><p>Gavote {$a->earned} iš {$a->outof} už šį esė klausimą.</p><p>Jūsų įvertis pamokai {$a->lesson} pakeistas į {$a->newgrade} %.</p>';
$string['essayemailmessagesmall'] = '<p>Gavote {$a->earned} iš {$a->outof} už šį esė klausimą.</p><p>Jūsų įvertis už {$a->lesson} pamoką buvo pakeistas į{$a->newgrade}%.</p>';
...
$string['minimumnumberofquestions_help'] = 'Šis parametras nurodo minimalų klausimų skaičių, pagal kurį bus skaičiuojamas veiklos įvertis.';
...
$string['score'] = 'Balas';
$string['score_help'] = 'Balas naudojamas tik tuo atveju, jei įjungtas pasirinktinis vertinimas balais. Kiekvienam atsakymui gali būti suteikta skaitinė taškų reikšmė (teigiama arba neigiama).';
$string['scores'] = 'Balai';
