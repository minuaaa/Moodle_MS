...
/**
 * Strings for component 'quiz', language 'lt', version '4.2'.
 *
 * @package     quiz
 * @category    string
...
$string['completionattemptsexhausted'] = 'Arba visi galimi bandymai baigti';
$string['completionattemptsexhausted_help'] = 'Pažymėti testo užbaigimą, kai studentas išnaudojo maksimalų bandymų skaičių.';
$string['completionattemptsexhausteddesc'] = 'Užbaigti, jei visi leidžiami bandymai yra išnaudoti';
$string['completiondetail:minattempts'] = 'Atlikti bandymų: {$a}';
$string['completiondetail:passgrade'] = 'Gauti išlaikymo įvertinimą';
...
$string['completionpass'] = 'Privalomas išlaikymo įvertinimas';
$string['completionpass_help'] = 'Jei įjungta, ši veikla laikoma baigta, kai besimokantysis gauna išlaikymo įvertį (kaip nurodyta testo nustatymų skiltyje Įvertinimas) arba aukštesnį.';
$string['completionpassdesc'] = 'Besimokantysis turi pasiekti išlaikymo įvertį šios veiklos užbaigimui';
...
$string['gradetopassmustbeset'] = 'Išlaikymo įvertis negali būti nulis, nes teste yra taikomas užbaigimo metodas, kuriame nustatytas išlaikymo įvertis. Prašome nustatyti ne nulinę reikšmę.';
$string['gradetopassnotset'] = 'Šiam testui dar nėra nurodytas išlaikymo įvertinimas. Jį galima nurodyti testo nustatymų skiltyje Įvertinimas.';
...
$string['legacyquizaccessrulescron'] = 'Pasenusios cron testo prieigos taisyklės';
$string['legacyquizreportscron'] = 'Pasenusios cron testo ataskaitos';
$string['link'] = 'Saitas';
...
$string['marks'] = 'Balai';
$string['marks_help'] = 'Skaitinis balas kiekvienam klausimui ir bendras bandymo rezultatas.';
...
$string['mustbesubmittedby'] = 'Atsakymą turi pateikti {$a}.';
...
$string['noreviewshort'] = 'Neleidžiama';
