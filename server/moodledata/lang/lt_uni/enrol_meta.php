...
/**
 * Strings for component 'enrol_meta', language 'lt_uni', version '4.2'.
 *
 * @package     enrol_meta
 * @category    string
...
$string['meta:unenrol'] = 'Išregistruoti sulaikytus vartotojus';
...
$string['syncall'] = 'Sinchronizuoti visus registruotus vartotojus';
$string['syncall_desc'] = 'Jei įjungta visi registruoti vartotojai yra sinchronizuojami netgi jei jie neturi jokios rolės savo pirminiame kurse, jei išjungta tik vartotojai turintys bent vieną sinchronizuotą rolę yra įregistruojami į kursą';
