...
/**
 * Strings for component 'tool_installaddon', language 'lt', version '4.2'.
 *
...
$string['installfromrepo_help'] = 'Būsite nukreipti į Moodle įskiepių katalogą, kur galėsite ieškoti ir įdiegti papildinį. Atminkite, kad taip pat bus išsiųstas visas jūsų svetainės pavadinimas, URL ir Moodle versija, kad jums būtų lengviau įdiegti.';
$string['installfromzip'] = 'Įdiegti papildinį iš ZIP failo';
$string['installfromzip_help'] = 'Alternatyva įdiegti papildinį tiesiai iš Moodle įskiepių katalogo yra įkelti įskiepio ZIP paketą. ZIP paketo struktūra turi būti tokia pati kaip paketo, atsisiųsto iš Moodle įskiepių katalogo.';
$string['installfromzipfile'] = 'ZIP paketas';
$string['installfromzipfile_help'] = 'Papildinio ZIP pakete turi būti tik vienas katalogas, pavadintas taip, kad atitiktų papildinio pavadinimą. ZIP bus išskleistas į atitinkamą papildinio tipo vietą. Jei paketas buvo atsisiųstas iš Moodle įskiepių katalogo, jis turės tokią struktūrą.';
...
$string['remoterequestalreadyinstalled'] = 'Yra užklausa įdiegti papildinio {$a->name} ({$a->component}) versiją {$a->version} iš Moodle įskiepių katalogo šioje svetainėje. Tačiau šis papildinys <strong>jau įdiegtas</strong> svetainėje.';
...
$string['typedetectionmismatch'] = 'Pasirinktas papildinio tipas neatitinka įskiepio deklaruojamo tipo: {$a}';
