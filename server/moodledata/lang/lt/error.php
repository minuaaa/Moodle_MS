...
$string['invalidcoursemoduleid'] = 'Netinkamas kursų modulio ID: {$a}';
...
$string['sessionerroruser2'] = 'Aptikta serverio klaida, turinti įtakos prisijungimo seansui. Prisijunkite dar kartą arba iš naujo paleiskite naršyklę.';
