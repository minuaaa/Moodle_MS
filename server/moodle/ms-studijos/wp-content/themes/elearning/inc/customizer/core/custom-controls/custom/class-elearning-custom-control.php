 ...
 *
 * Class eLearning_Custom_Control
 *
 * @package    ThemeGrill
 ...
 * Class eLearning_Custom_Control
 */
class eLearning_Custom_Control extends eLearning_Customize_Base_Additional_Control {
	...
	protected function content_template() {
		...
		<# if ( data.info ) { #>
		<div class="elearning-custom-info">
			{{{ data.info }}}
		</div>
		<# } #>

		<# if ( data.links ) { #>
		<ul class="elearning-custom-links">
