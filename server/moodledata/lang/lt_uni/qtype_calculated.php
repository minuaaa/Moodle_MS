...
/**
 * Strings for component 'qtype_calculated', language 'lt_uni', version '4.2'.
 *
...
$string['pluginname'] = 'Suskaičiuojamas';
...
$string['pluginnameadding'] = 'Pridėti apskaičiuotą klausimą';
...
$string['synchronize'] = 'Sinchronizuoti bendrai naudojamų duomenų rinkinių duomenis su kitais testo klausimais';
$string['synchronizeno'] = 'Nesinchronizuoti';
$string['synchronizeyes'] = 'Sinchronizuoti';
$string['synchronizeyesdisplay'] = 'Sinchronizuoti ir rodyti bendrai naudojamų duomenų rinkinių pavadinimą kaip klausimo pavadinimo priešvardį';
$string['tolerance'] = 'Leistinas nuokrypis &plusmn;';
