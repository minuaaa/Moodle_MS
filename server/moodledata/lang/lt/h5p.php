...
/**
 * Strings for component 'h5p', language 'lt', version '4.2'.
 *
 * @package     h5p
 * @category    string
...
$string['level'] = 'Lygis';
$string['librariesmanagerdescription'] = '<p>H5P suteikia galimybę naudotojams kurti interaktyvų turinį pateikiant įvairių tipų turinį.</p><p>Norėdami užtikrinti, kad svetainėje būtų naudojami tik patikimi H5P turinio tipai, turite <i>arba</i> </p><ul><li>Įkelti H5P turinio tipus iš h5p.org <i>arba</i></li><li>Įgalinti suplanuotą užduotį „Atsisiųsti galimus H5P turinio tipus iš h5p.org“</i> li></ul><p>Atminkite, kad naudotojai galės naudoti tik jūsų svetainėje įdiegtus H5P turinio tipus.</p>';
